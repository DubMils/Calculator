...
btn_mul = tk.Button(root, text="x", command=lambda: add_to_calculation("*"), width=5, height=2, font=("Arial", 14))
btn_mul.grid(row=4, column=4)
btn_div = tk.Button(root, text="/", command=lambda: add_to_calculation("/"), width=5, height=2, font=("Arial", 14))
btn_div.grid(row=5, column=4)
btn_open = tk.Button(root, text="(", command=lambda: add_to_calculation("("), width=5, height=2, bg=("#2a2d36"),font=("Arial", 14))
btn_open.grid(row=5, column=1)
btn_close = tk.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, height=2, bg=("#2a2d36"),font=("Arial", 14))
btn_close.grid(row=5, column=3)
btn_erase = tk.Button(root, text="C", command=clear_field, width=15,height=2,font=("Arial", 14))
btn_erase.grid(row=6, column=1 , columnspan=2)
btn_equals = tk.Button(root, text="=", command=evaluate_calculation, width=15, height=2, font=("Arial", 14))
